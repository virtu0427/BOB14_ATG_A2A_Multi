"""Standalone FastAPI application for the inbound agent."""
...
class InboundHandler(SQLiteAgent):
    """Records inbound inventory items."""

    def __init__(self) -> None:
        super().__init__("inbound.db", "items", "description", "item recorded")
