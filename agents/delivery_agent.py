"""Standalone FastAPI application for the delivery agent."""
...
class DeliveryHandler(SQLiteAgent):
    """Logs shipment updates."""

    def __init__(self) -> None:
        super().__init__("delivery.db", "deliveries", "status", "delivery updated")
